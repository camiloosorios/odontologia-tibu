    ...
    <>
      <Header>
        ...
        <div className="mt-10 flex justify-center lg:justify-end lg:mx-20 items-center gap-10">
          <Link href="https://www.facebook.com/people/Consultorio-Odontolog%C3%ADa-Tib%C3%BA/61563906201342/" target='_blank' rel="noopener noreferrer">
            <Image src="/fb-icon.svg" alt="Icono de facebook" width={25} height={25}></Image>
          </Link>
          <Link href="https://www.instagram.com/od.llencyjaimes/?igsh=MWdrMDJzaXc2bmthbw%3D%3D" target='_blank' rel="noopener noreferrer">
            <Image src="/ig-icon.svg" alt="Icono de instagram" width={35} height={35}></Image>
          </Link>
        </div>
      </Header>
      <main className="bg-gray-300">
        <div className="container mx-auto py-20 md:py-30 grid md:grid-cols-2 md:items-center">
          ...
          <div className="flex justify-center">
            <Image src="/image1.jpg" alt='Imagen de paciente en el consultorio' width={600} height={600} className="md:rounded-l-3xl shadow-lg"></Image>
          </div>
        </div>
      </main>
      <section className="grid grid-cols-1 md:grid-cols-3 py-20 md:py-32 bg-teal-400 gap-10 px-5 xl:px-60">
        <div className="mb-10 md:mb-0 md:container">
          <Image src="/check-icon.svg" width={50} height={50} alt="Icono de check" className="inline-block p-2"></Image>
      ...
      <section className="bg-gray-300" id="about-us">
        <div className="container mx-auto py-20 md:py-30 grid md:grid-cols-2 md:items-center">
          <div className="flex justify-center">
            <Image src="/odontologa.jpg" alt="Odontóloga Llency Jaimes Sanabria en su consultorio" width={400} height={600} className="md:rounded-3xl shadow-lg w-full md:w-[500px]"></Image>
          </div>
          <div className="mb-10">
      ...
      <section className="bg-gray-300" id="location">
        <div className="container mx-auto py-20 md:py-30 grid md:grid-cols-2 md:items-center">
          ...
          <div className="">
            <Image src="/ubicacion.jpg" width={650} height={500} alt="Ubicacion odontologia en tibu" className="shadow-lg"></Image>
          </div>
        </div>
      ...
      <div className="w-72 flex fixed bottom-5 right-5 bg-green-500 text-white justify-between rounded-xl py-2">
        <Link href="https://api.whatsapp.com/send?phone=573135477178&text=Hola%20me%20gustaria%20obtener%20mas%20informaci%C3%B3n%20sobre%20tus%20servicios!%F0%9F%98%80" target="_blank" rel="noopener noreferrer" className="flex items-center mx-auto gap-5"><Image src="/whatsapp.svg" alt="Logo de whatsapp" width={35} height={35}></Image>¿Tienes alguna duda?</Link>
      </div>
      <Footer />
    </>
  );
