...
export default function Header({ children }: { children: React.ReactNode }) {
    ...
    return (
        <header className="relative lg:h-[70vh]">
            <div className="absolute inset-0 bg-cover bg-center bg-[url('/background.jpg')]"></div>
            <div className="absolute inset-0 bg-black opacity-50"></div>
            <div className="relative container mx-auto">
                <div className="pt-5 lg:flex items-start lg:items-center justify-between">
                    <div className="flex justify-between">
                        <Link href="/" aria-label="Inicio">
                            <Image src="/logo.png" alt="Logo del consultorio dental" width={400} height={400} className="w-3/5 lg:w-[400px]" />
                        </Link>
                        <button onClick={toggleMenu} aria-label="Menú" className="lg:hidden">
                            <Image src="/menu.svg" alt="Ícono de menú" width={40} height={40} />
                        </button>
                    </div>
